# CS2102 Project - CosMaS (Group 50)
...
1. Create a file named `.env` under the project root directory and copy the following content or the content in the `.env.template` to it.
